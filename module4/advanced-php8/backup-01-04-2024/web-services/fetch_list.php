...
<body>
    ...
    <!-- web services  : fetch any url data or json data inside of your webpage i.e called web services
     http://localhost/php-1130mwf/module4/advanced-php8/web-services/country.json
    -->
        ...
        <form method="post">
            <div class="form-group">
                <select name="country" class="form-control">
                    ...
                    <?php 
                    $url="http://localhost/php-1130mwf/module4/advanced-php8/web-services/country.json";
