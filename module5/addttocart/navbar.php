<?php 
$mainurl="http://localhost/php-1130mwf/module5/addttocart/";
?>
<!DOCTYPE html>
<html>
<head>
...
<li class="nav-item">
<a class="nav-link" href="<?php echo $mainurl;?>view-cart">ViewCart <span class="bi bi-cart"><span class="badge badge-sm bg-danger"><?php echo $totalcrt[0]["total"];?></span></span></a>
</li>
</ul>
</div>
</div>
